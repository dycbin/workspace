...
public class SampleWithWindow extends JFrame {
	...
	// 编辑部分
	// TODO APPID
	public static final String APP_ID = "ceefadb5";// 微吼APPKEY
	public static final String SECRET_KEY = "35c10cc38a7a09a532150719ae5932c5";// 微吼SECRETKEY
	public static final String callbackurl = "http://t.e.vhall.com/api/callback";
	public static final String videoName = "撒奋斗三分的";
